...
### - [x] receber uma palavra (string).
### - [x] Calcular a quantidade de vogais e a quantidade consoantes da palavra;
...
### Link: [Projeto](https://alinealmeida85.github.io/Jovens-Tegranos-Exercicio26/)
